package com.anu.yubisa.adapter;
...
import com.anu.yubisa.DetailsActivity;
import com.anu.yubisa.MainActivity;
import com.anu.yubisa.model.PopularFood;
import com.anu.yubisa.DetailsActivity;
import com.anu.yubisa.MainActivity;
import com.anu.yubisa.R;
import com.anu.yubisa.model.PopularFood;
...
public class PopularFoodAdapter extends RecyclerView.Adapter<PopularFoodAdapter.PopularFoodViewHolder> {
    ...
    public PopularFoodAdapter(MainActivity context, List<PopularFood> popularFoodList) {
